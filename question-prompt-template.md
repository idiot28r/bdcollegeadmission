...
2. **No Leading Numbers:** Do NOT include the question number/serial at the start of the `question`, `stimulus`, or `parts.question` text. It is handled by the UI.
3. **Labels:** ONLY include `label` if there is a `stimulus` OR if there are multiple parts (a, b, c). For single-part SQs without a stimulus, omit the `label` or leave it empty.
...
**SQ (Multi-part):** `[{"serial":"5","type":"sq","institution":"SJHSS","year":"2022","subject":"Math","topic":"Algebra","stimulus":"$x+y=5$","parts":[{"label":"ক","question":"Find y if x=2","mark":2},{"label":"খ","question":"Find x if y=1","mark":2}],"solution":"<p><strong>ক)</strong> $y=3$</p><p><strong>খ)</strong> $x=4$</p>"}]`
